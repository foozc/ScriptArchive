...
internal class BMDataAccessor
{
    ...
    public const string BundleDataPath = "Assets/Scripts/Tools/BundleManager/BundleData.txt";
    public const string BMConfigerPath = "Assets/Scripts/Tools/BundleManager/BMConfiger.txt";
    public const string BundleBuildStatePath = "Assets/Scripts/Tools/BundleManager/BuildStates.txt";
	public const string UrlDataPath = "Assets/Scripts/Tools/BundleManager/Resources/Urls.txt";
}

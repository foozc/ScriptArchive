...
*Desciption:功能说明:NGUI,UIPlayTween改写的类
*Author:作者
*
*/
/// <summary>
...
public class MyUIPlayTween : MonoBehaviour
{
	static public MyUIPlayTween current;
	...
	public void Play (bool forward)
	{
		...
		foreach (Transform item in tweenTarget.GetComponentInChildren<Transform>())
		{

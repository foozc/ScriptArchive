...
namespace Mysql.Util
{
    ...
    {
        //数据库连接字符串
        public static string _connectionString = "server=" + GlobalConfig.DBHost + ";user id=" + GlobalConfig.DBID +
            ";password=" + GlobalConfig.DBPWD + ";database=" + GlobalConfig.DbName + ";charset=utf8;port=" + GlobalConfig.DBPort + ";";
        ...
        public static string connectionString
        {
            ...
            {
                initDB();
                _connectionString = "server=" + GlobalConfig.DBHost + ";user id=" + GlobalConfig.DBID +
            ";password=" + GlobalConfig.DBPWD + ";database=" + GlobalConfig.DbName + ";charset=utf8;port=" + GlobalConfig.DBPort + ";";
        ...
        {
            string path = UnityEngine.Application.streamingAssetsPath + "/DBConfig.xml";
            XmlDocument doc = new XmlDocument();
            try
            {
                doc.Load(path);
                GlobalConfig.DBHost = doc.SelectSingleNode("data").SelectSingleNode("DBHost").Attributes["name"].Value;
                GlobalConfig.DBPort = doc.SelectSingleNode("data").SelectSingleNode("DBPort").Attributes["name"].Value;
                GlobalConfig.DBID = doc.SelectSingleNode("data").SelectSingleNode("DBID").Attributes["name"].Value;
                GlobalConfig.DBPWD = doc.SelectSingleNode("data").SelectSingleNode("DBPWD").Attributes["name"].Value;
                GlobalConfig.DbName = doc.SelectSingleNode("data").SelectSingleNode("DbName").Attributes["name"].Value;
            }
            catch (Exception e)
            {
        ...
        public static void CloseConn()
        {
            ...
            {
                UnityEngine.Debug.LogError(o.Message);
            }
        }
